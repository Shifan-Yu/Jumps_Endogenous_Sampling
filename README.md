...
* **Simulators**
  Heston dynamics for the efficient price with **tick-level** observations. Jump **levels** (compound Laplace) can be added at controlled intensities/sizes; an option with **microstructure noise** (autocorrelated Gaussian-$M_{c}$ mixture noise) is included.
